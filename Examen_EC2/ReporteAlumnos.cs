...
namespace Examen_EC2
{
    public partial class ReporteAlumnos : Form
    {
        ...
        private void ReporteAlumnos_Load(object sender, EventArgs e)
        {
            ...
            // TODO: esta línea de código carga datos en la tabla 'ConjuntoExamen.MostrarAlumnos' Puede moverla o quitarla según sea necesario.
            this.MostrarAlumnosTableAdapter.Fill(this.ConjuntoExamen.MostrarAlumnos);
